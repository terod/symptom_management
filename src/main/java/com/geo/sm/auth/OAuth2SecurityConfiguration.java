...
public class OAuth2SecurityConfiguration {
	...
	protected static class OAuth2Config extends
		...
		public OAuth2Config() throws Exception {
			...
			/*
			 * //creating an arraylist to hold credentials List<UserDetails>
			 * loginCredentials = new ArrayList<UserDetails>(); //adding admin
			 * user loginCredentials.add(User.create("admin", "pass", "ADMIN",
			 * "USER"));
			 * 
			 * //fetching patients from database List<Patient> patientList =
			 * (List<Patient>) patientRepository.findAll(); for(Patient patient
			 * : patientList){
			 * loginCredentials.add(User.create(patient.getUserName
			 * (),patient.getPassword(),"USER")); }
			 * 
			 * //fetching doctors from database List<Doctor> doctorList =
			 * (List<Doctor>) doctorRepository.findAll(); for(Doctor doctor :
			 * doctorList){
			 * loginCredentials.add(User.create(doctor.getUserName()
			 * ,doctor.getPassword(),"USER")); }
			 */
			...
			UserDetailsService svc = new InMemoryUserDetailsManager(
					Arrays.asList(
							...
							User.create("doc1", "somepassword", "USER"),
							User.create("jack", "somepassword", "USER"),
							User.create("will", "somepassword", "USER"),
							User.create("doc2", "somepassword", "USER")));
